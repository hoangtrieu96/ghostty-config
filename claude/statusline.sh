...
CYAN='\033[36m'; MAGENTA='\033[35m'; BLUE='\033[34m'; GREEN='\033[32m'; YELLOW='\033[33m'; RED='\033[31m'; CLAUDE_ORANGE='\033[38;2;217;119;87m'; RESET='\033[0m'
...
echo -e "${CLAUDE_ORANGE}${ICON_MODEL} [$MODEL]${RESET} ${BLUE}${ICON_DIR} ${DIR}${RESET}$BRANCH | ${BAR_COLOR}${ICON_CONTEXT} ${BAR} ${REMAINING}% remaining context${RESET} | ${CYAN}${ICON_TOKENS} ${USED_TOKENS_FMT}/${TOTAL_TOKENS_FMT} tokens${RESET}"
